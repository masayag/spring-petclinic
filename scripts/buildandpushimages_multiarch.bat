...
:DEFAULT_REGISTRY
    ...
    SET REGISTRY_NAMESPACE=demo-proj
	GOTO DOCKER_CONTAINER_RUNTIME
...
IF  "%CONTAINER_RUNTIME%" == "docker" (
    ...
    podman manifest create ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/spring-petclinic-buildstage
    podman build --platform ${PLATFORMS} -f Dockerfile.buildstage --manifest ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/spring-petclinic-buildstage .
    podman manifest push ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/spring-petclinic-buildstage
)
popd
...
IF  "%CONTAINER_RUNTIME%" == "docker" (
    ...
    podman manifest create ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/spring-petclinic
    podman build --platform ${PLATFORMS} -f Dockerfile --manifest ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/spring-petclinic .
    podman manifest push ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/spring-petclinic
)
popd
